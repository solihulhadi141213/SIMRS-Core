<?php
    ...
    $Url=urlService('Edit Ruang Rawat');
    $updatetime=date('Y-m-d H:i');
    //Validasi Form Data
    if(empty($_POST['ruang_rawat_lama'])){
        echo '<span class="text-danger">Nama Ruang Rawat Lama Tidak Boleh Kosong</span>';
    }else{
                ...
                if(empty($_POST['kode'])){
                    ...
                    if(empty($_POST['kapasitas'])){
                        ...
                        if(empty($_POST['status'])){
                            ...
                            $ruang_rawat_lama=$_POST['ruang_rawat_lama'];
                            ...
                            $KirimData = array(
                                'api_key' => $api_key,
                                'ruang_rawat_lama' => $ruang_rawat_lama,
                            ...
                            if(!empty($err)){
                                ...
                                if($code==200){
                                    echo '<span class="text-success" id="NotifikasiEditRuanganBerhasil">Success</span>';
                                }else{
