    ...
    if(empty($_POST['keyword_by'])){
        ...
        if($keyword_by=="kode"){
            ...
            if($keyword_by=="nama"){
                ...
                if($keyword_by=="spesialis"){
                    echo '<select name="keyword" id="keyword" class="form-control">';
                        $url=urlService('Info Dokter');
                        $KirimData = array(
                            'api_key' => $api_key,
                            'keyword_by' => "",
                            'keyword' => "",
                        ...
                        if(!empty($err)){
                            ...
                            if($code==200){
                                $JumlahSpesialis=count($JsonData['response']['spesialis']);
                                if(!empty($JumlahSpesialis)){
                                    echo '<option value="">Pilih</option>';
                                    $ListSpesialis=$JsonData['response']['spesialis'];
                                    foreach ($ListSpesialis as $value){
