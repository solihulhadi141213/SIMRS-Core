<?php
    ...
    if(empty($_POST['id_laporan_pengguna'])){
        ...
        echo '<input type="hidden" name="id_laporan_pengguna" value="'.$id_laporan_pengguna.'">';
        ...
        echo '      <label for="response">Isi Response Disini</label>';
        echo '      <textarea name="response" id="response" class="form-control">'.$response.'</textarea>';
        echo '  </div>';
        echo '</div>';
?>
