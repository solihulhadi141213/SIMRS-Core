                ...
                foreach ($ReferensiTt as $item) {
                    ...
                    if($IdTtList==$id_tt){
                        ...
                        if(!empty($id_ruang_rawat)){
                            ...
                            $kodekelas='<span class="text-danger">Tidak ADa</span>';
                        }
...
?>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <label for="ruang">Rekap Data Ruangan</label>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="terpakai_suspek" id="terpakai_suspek" class="form-control" value="">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="terpakai_konfirmasi" id="terpakai_konfirmasi" class="form-control" value="">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="antrian" id="antrian" class="form-control" value="">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="prepare" id="prepare" class="form-control" value="">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="prepare_plan" id="prepare_plan" class="form-control" value="">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            <input type="text" min="0" name="covid" id="covid" class="form-control" value="">
        </div>
    </div>
<?php }}}}} ?>