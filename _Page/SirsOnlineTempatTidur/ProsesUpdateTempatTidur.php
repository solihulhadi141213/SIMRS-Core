                                ...
                                if(!is_numeric($prepare)){
                                    ...
                                    if(!is_numeric($prepare_plan)){
                                        ...
                                        if(!is_numeric($covid)){
                                            ...
                                            //Kirim Data
                                            $KirimData=UpdateTempatTidur($x_id_rs,$password_sirs_online,$url_sirs_online,$json_data);
                                            if(empty($KirimData)){
                                                ...
                                                if($status=="200"){
                                                    echo '<span class="text-success" id="NotifikasiUpdateTempatTidurBerhasil">Success</span>';
                                                }else{
