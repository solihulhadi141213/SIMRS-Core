                                                                ...
                                                                if(empty($_POST['angkaantrean'])){
                                                                    ...
                                                                    if(empty($_POST['tanggal_estimasidilayani'])){
                                                                        ...
                                                                        if(empty($_POST['jam_estimasidilayani'])){
                                                                            ...
                                                                            //Kirim Data
                                                                            $KirimData=CreatBookingAntrian($x_id_rs,$password_sirs_online,$url_sirs_online,$json_data);
                                                                            $response = json_decode($KirimData, true);
                                                                            $status=$response['antrian'][0]['status'];
                                                                            if($status=="200"){
                                                                                $MenyimpanLog=getSaveLog($Conn,$WaktuLog,$SessionNama,"Creat Booking Antrian","Antrian SIRS Online",$SessionIdAkses,$LogJsonFile);
                                                                                if($MenyimpanLog=="Berhasil"){
                                                                                    echo '<span class="text-success" id="NotifikasiProsesAddAntrianBerhasil">Success</span>';
                                                                                }else{
                                                                                    echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                                                                                }
                                                                            }else{
                                                                                echo '<span class="text-danger">Creat Booking Antrian Gagal!</span>';
                                                                            }
                                                                        }
                                                                    }
                                                                }
