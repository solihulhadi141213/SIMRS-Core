            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center"><img src="<?php echo "$hero_img"; ?>" width="50px"></td>
                        <td class="text-left"><?php echo "<dt>$hero_title</dt>Sub: $hero_deskripsi"; ?></td>
                        <td class="text-left"><?php echo "<dt>$hero_button</dt>$hero_url"; ?></td>
                        <td class="text-center">
                            <div class="btn-group dropdown-split-inverse">
                                ...
                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(107px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    ...
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalEditSlider" data-id="<?php echo "$id_web_hero"; ?>">
                                        <i class="ti-pencil"></i> Edit
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalHapustSlider" data-id="<?php echo "$id_web_hero"; ?>">
