...
?>
    <form action="javascript:void(0);" method="POST" id="ProsesPendaftaranPasienBaru" autocomplete="off">
        ...
        <input type="hidden" name="metode_pembayaran" id="metode_pembayaran" value="BPJS">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <dt>Pendaftaran Pasien BPJS (Pendaftaran Baru)</dt>
                    <p class="text-muted">
                        <i>
                            <b>
                                <i class="ti ti-info-alt"></i>
                                Informasi Pendaftaran :<br>
                                Pastikan anda memiliki nomor KTP (NIK) dan nomor kartu BPJS yang valid untuk mendaftar sebagai pasien baru.
                            </b>
                        </i>
                    </p>
                </div>
...
?>
    <form action="javascript:void(0);" method="POST" id="ProsesPencarianPasienLama" autocomplete="off">
        ...
        <div class="row">
                <div class="col-md-12">
                    <dt><i class="ti ti-info-alt"></i> Informasi Pendaftaran Pasien BPJS (Pasien Lama)</dt>
                    <small class="text-muted">
                        <i>
                            <ul>
                                <li>
                                    - Berikut ini adalah pendaftaran hanya untuk pasien BPJS yang sudah pernah terdaftar sebelumnya (Pasien Lama).
                                </li>
                                <li>
                                    - Pastikan anda memiliki nomor KTP (NIK) / nomor kartu BPJS yang valid atau nomor RM pada kartu berobat untuk melanjutkan pendaftaran sebagai pasien lama.
                                </li>
                                <li>
                                    - Untuk kategori pendaftaran pasien baru atau pasien UMUM silahkan klik tombol kembali pada bagian bawah halaman ini.
                                </li>
                            </ul>
                        </i>
                    </small>
            ...
            <div class="row">
                <div class="col-md-6 mt-4">
                    <label for="kategori_id"><dt>Pilih Kategori ID</dt></label>
                    <select name="kategori_id" id="kategori_id" class="form-control">
                        <option value="" selected>Pilih</option>
                        <option value="id_pasien">No RM</option>
                        <option value="nik">No NIK (KTP)</option>
                        <option value="no_bpjs">No Kartu (BPJS)</option>
                    </select>
                </div>
                <div class="col-md-6 mt-4">
