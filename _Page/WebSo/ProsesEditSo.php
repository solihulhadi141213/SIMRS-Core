<?php
    ...
    $url=urlService('Edit So');
    //Validasi nama tidak boleh kosong
    if(empty($_POST['nama'])){
        echo '<span class="text-danger">Nama Tidak Boleh Kosong</span>';
    }else{
        //Validasi id_struktur_organisasi tidak boleh kosong
        if(empty($_POST['id_struktur_organisasi'])){
            echo '<span class="text-danger">ID Struktur Organiasasi Tidak Boleh Kosong</span>';
        }else{
            if(empty($_POST['key_struktur_organisasi'])){
                echo '<span class="text-danger">Key Struktur Organiasasi Tidak Boleh Kosong</span>';
            }else{
                if(empty($_POST['job_title'])){
                    ...
                    if(empty($_POST['NIP'])){
                        ...
                        $key_struktur_organisasi=$_POST['key_struktur_organisasi'];
                        $nama=$_POST['nama'];
                        ...
                        if($ValidasiGambar!=="Valid"){
                            ...
                            $KirimData = array(
                                ...
                                'key_struktur_organisasi' => $key_struktur_organisasi,
                                'boss' => $boss,
                                'nama' => $nama,
                                'job_title' => $job_title,
                                'NIP' => $NIP,
                            ...
                            if(!empty($err)){
                                ...
                                if($code!==200){
                                    ...
                                    $_SESSION['NotifikasiSwal']="Edit SO Berhasil";
                                    echo '<span class="text-success" id="NotifikasiEditSoBerhasil">Success</span>';
                                }
                            }
                        }
                    }
