        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="ti-help"></i> Bantuan Website</a>
                    </h5>
                    <p class="m-b-0">Kelola data bantuan yang ditampilkan halaman website</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-header border-info">
                                <form action="javascript:void(0);" id="BatasPencarian">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <a href="index.php?Page=WebBantuan&Sub=TambahBantuan" class="btn btn-sm btn-block btn-primary">
                                                <i class="ti-plus text-white"></i> Tambah Bantuan
                                            </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div id="MenampilkanTabelBantuan">
                                <!--  menampilkan data Bantuan disini -->
                            </div>
                        </div>
                    </div>
                </div>
