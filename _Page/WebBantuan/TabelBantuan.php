<?php
    ...
    $UrlInfo=urlService('Info Bantuan');
    $UrlList=urlService('List Bantuan');
    //keyword
            ...
            <tbody>
                ...
                ?>
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#ModalDetailBantuan" data-id="<?php echo "$id_bantuan"; ?>">
                                                    <?php echo "$judul"; ?>    
                                                </a>
                                            </td>
                                            <td class="text-left"><?php echo "$kategori"; ?></td>
                                            <td class="text-left"><?php echo "$TanggalFormat"; ?></td>
                                            <td class="text-center">
                                                <div class="btn-group dropdown-split-inverse">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(107px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                        <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalDetailBantuan" data-id="<?php echo "$id_bantuan"; ?>">
                                                            <i class="ti-info"></i> Detail
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a href="index.php?Page=WebBantuan&Sub=EditBantuan&id=<?php echo "$id_bantuan"; ?>"  class="dropdown-item waves-effect waves-light">
                                                            <i class="ti-pencil"></i> Edit
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalHapusBantuan" data-id="<?php echo "$id_bantuan"; ?>">
