...
?>
<form action="javascript:void(0);" id="ProsesEditWilayah" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <input type="text" name="propinsi" id="propinsi" list="DataListPropinsi" class="form-control" value="<?php echo "$propinsi"; ?>" required>
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <input type="text" name="kabupaten" id="kabupaten" list="DataListKabupaten" class="form-control" value="<?php echo "$kabupaten"; ?>">
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <input type="text" name="kecamatan" id="kecamatan" list="DataListKecamatan" class="form-control" value="<?php echo "$kecamatan"; ?>">
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <input type="text" name="desa" id="desa" list="DataListDesa" class="form-control" value="<?php echo "$desa"; ?>">
                <datalist id="DataListDesa">
                </datalist>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mt-3" id="NotifikasiEditWilayah">
                <small>
                    <dt>Keterangan :</dt>
    ...
    <div class="modal-footer bg-primary">
        <div class="row">
            <div class="col-md-12">
                ...
                <button type="button" class="btn btn-sm btn-light mr-2" data-dismiss="modal">
