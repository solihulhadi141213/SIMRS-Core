        ...
        if(empty($_POST['KodeKabupaten'])){
            ...
            echo '<ul class="list-group pre-scrollable">';
                ...
                for($a=0; $a<$Jumlah; $a++){
                    ...
                    $nama=$list[$a]['nama'];
    ?>
        <li tabindex="0" onmousemove="this.style.cursor='pointer'" class="list-group-item" data-toggle="modal" data-target="#ModalGetDesa" data-id="<?php echo ''.$kode.','.$nama.''; ?>">
            <?php echo ''.$no.'.'.$nama.' ('.$kode.')'; ?>
        </li>
    <?php 
        $no++;}} 
    ?>
