<?php
    ...
    if(empty($_GET['kode'])){
        ...
        echo '              Kode Obat/Alkes Tidak Boleh Kosong!';
        echo '          </div>';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
        ...
        $kode=$_GET['kode'];
        $id_obat_medication=getDataDetail($Conn,'obat_medication','kode',$kode,'id_obat_medication');
        //Buka data obat
        if(empty($id_obat_medication)){
            echo '<div class="row">';
            echo '  <div class="col-md-12">';
            echo '      <div class="card">';
            echo '          <div class="card-body text-center text-danger">';
            echo '              Kode Obat/Alkes Tidak Valid!';
            echo '          </div>';
            echo '      </div>';
            echo '  </div>';
            echo '</div>';
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <h4 class="card-title"><i class="ti ti-info-alt"></i> Detail Medication</h4>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="index.php?Page=Medication" class="btn btn-sm btn-block btn-dark btn-round">
                                <i class="ti ti-arrow-circle-left"></i> Kembali
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="javascript:void(0);" class="btn btn-sm btn-block btn-success btn-round" class='text-info' data-toggle="modal" data-target="#ModalEditMedication" data-id="<?php echo "$id_obat_medication" ?>">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingTwo" style="">
                                        <div class="accordion-content accordion-desc">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 text-left"><code class="text-secondary"><?php echo "$resourceType"; ?></code></div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-4">2. Profile :</div>
                                                <div class="col-md-8 text-left"><code class="text-secondary"><?php echo "$profile"; ?></code></div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 text-left"><code class="text-secondary"><?php echo "$status"; ?></code></div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-4">6. Manufacturer</div>
                                                <div class="col-md-8 text-left"><code class="text-secondary"><?php echo "$manufacturer"; ?></code></div>
                                            </div>
                                            <div class="row mb-3">
