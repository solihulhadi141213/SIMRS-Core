                                                                    ...
                                                                    if(empty($_POST['extension_code'])){
                                                                        ...
                                                                        if(empty($_POST['extension_display'])){
                                                                            ...
                                                                            if(empty($id_obat)){
                                                                                ...
                                                                                $response=CreatMedication($baseurl_satusehat,$JsonEncode,$Token);
                                                                                if(empty($response)){
                                                                                    ...
                                                                                    if(empty($JsonData['id'])){
                                                                                        ...
                                                                                        //Simpan Data Ke Database obat_medication
                                                                                        $entry="INSERT INTO obat_medication (
                                                                                            id_obat,
                                                                                            id_medication,
                                                                                            kode,
                                                                                            nama,
                                                                                        ...
                                                                                        if($hasil){
                                                                                            ...
                                                                                            if($UpdateObat){
                                                                                                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Creat Medication","Medication",$SessionIdAkses,$LogJsonFile);
                                                                                                if($MenyimpanLog=="Berhasil"){
                                                                                                    $_SESSION['NotifikasiSwal']="Creat Medication Berhasil";
                                                                                                    echo '<span class="text-success" id="NotifikasiTambahMedicationBerhasil">Success</span>';
                                                                                                }else{
                                                                                                    echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                                                                                                }
                                                                                            }else{
                                                                                                echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Update Data Obat</span>';
                                                                                            }
                                                                                        }else{
