<?php
    ...
    //Tangkap id_laboratorium_parameter
    if(empty($_POST['id_laboratorium_parameter'])){
        echo '<div class="card-body border-0 pb-0">';
        echo '  <div class="row">';
        echo '      <div class="col-md-6 mb-3">';
        echo '          Data ID Laboratorium Tidak Dapat Didefinisikan.';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
    }else{
    ...
    <div class="modal-body border-0 pb-0 mb-4">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-danger">
                <span id="NotifikasiHapusParameter">
                    Apakah anda yakin akan menghapus data Parameter ini?
                </span>
            </div>
        </div>
    </div>
    <div class="modal-footer bg-danger">
        <div class="row">
            <div class="col-md-12 mb-3">
                <button type="button" class="btn btn-md btn-inverse mt-2 ml-2" id="KonfirmasiHapusParameter">
