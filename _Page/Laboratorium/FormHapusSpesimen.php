<?php
    ...
    if(empty($_POST['id_laboratorium_sample'])){
        ...
        echo '          Data ID Spesimen Tidak Dapat Didefinisikan.';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
    }else{
    ...
    <div class="modal-body border-0 pb-0 mb-4">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-danger">
                <span id="NotifikasiHapusSpesiemen">
                    Apakah anda yakin akan menghapus data spesimen ini?
                </span>
            </div>
        </div>
    </div>
    <div class="modal-footer bg-danger">
        <div class="row">
            <div class="col-md-12 mb-3">
                <button type="button" class="btn btn-md btn-inverse mt-2 ml-2" id="KonfirmasiHapusSpesimen">
