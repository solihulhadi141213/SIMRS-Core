<?php
    ...
    if (empty($_POST['id_setting_sifarma'])) {
        echo '
            <div class="alert alert-danger text-center">
                <small>ID setting Sifarma tidak boleh kosong.</small>
            </div>
        ';
        exit;
    }
    ...
    $stmt = mysqli_prepare(
        $Conn,
        "SELECT * FROM setting_sifarma WHERE id_setting_sifarma = ?"
    );
    ...
    if (!$result || mysqli_num_rows($result) == 0) {
        ...
        echo '
            <div class="alert alert-warning text-center">
                <small>Data setting Sifarma tidak ditemukan.</small>
            </div>
        ';
        exit;
    }
...
?>
    <input type="hidden" name="id_setting_sifarma" value="<?php echo $id_setting_sifarma; ?>">

    <div class="row mb-3">
        <div class="col-12">
            <label for="nama_setting_sifarma_edit"><small>Profil Pengaturan</small></label>
            <input
                type="text"
                name="nama_setting_sifarma"
                id="nama_setting_sifarma_edit"
                class="form-control"
    ...
    <div class="row mb-3">
        <div class="col-12">
            <label for="base_url_edit"><small><i>URL (ENDPOINT)</i></small></label>
            <input
                type="url"
                name="base_url"
                id="base_url_edit"
