<?php
    ...
    if(empty($_POST['id_operasi'])){
        ...
        if($Update){
            ...
            $nama_log="Update Jadwal Operasi Selesai Berhasil";
            $kategori_log="Jadwal Operasi";
            include "../../_Config/Log.php";
            echo '<span class="text-success" id="NotifikasiJadwalOperasiSelesaiBerhasil">Update Jadwal Berhasil</span>';
        }else{
            echo '<span class="text-danger" id="NotifikasiJadwalOperasiSelesaiBerhasil">Update Jadwal Operasi Gagal</span>';
        }
    }
?>
