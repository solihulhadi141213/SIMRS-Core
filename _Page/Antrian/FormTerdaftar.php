        ...
        <div class="row">
            <div class="col col-md-12 text-center">
                <div class="alert alert-info" role="alert">
                    <h3>Antrian : <?php echo $NoAntrian; ?> </h3>
                    Apakah anda yakin akan melakukan update Terdaftar untuk antrian ini?
                    <p id="NotifikasiTerdaftarAntrian"></p>
                </div>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <div class="row">
            <div class="col col-md col-12 text-center">
                <button type="button" class="btn btn-md btn-primary mt-2 mr-2" id="KonfirmasiTerdaftar">
