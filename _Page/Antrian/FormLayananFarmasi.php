    ...
    <div class="modal-body">   
        ...
        <div class="row mb-3">
            <div class="col col-md-12">
                <dt>Keterangan</dt>
                Dengan melakukan update data ini maka petugas farmasi telah membaca resep dan mempersiapkan obat.
            </div>
        </div>
        <div class="row mb-3">
            <div class="col col-md-12" id="NotifikasiLayananFarmasi">
    ...
    <div class="modal-footer bg-primary">
        <div class="row">
            <div class="col col-md col-12 text-center">
                <button type="button" class="btn btn-sm btn-success mr-2" id="KonfirmasiLayananFarmasi">
