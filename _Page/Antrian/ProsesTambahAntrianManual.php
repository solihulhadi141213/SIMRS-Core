<?php
    ...
    if(empty($_POST['KirimKeWsBpjs'])){
        $ws_bpjs="0";
    }else{
        $ws_bpjs=$_POST['KirimKeWsBpjs'];
    }
                                                        ...
                                                        if($JumlahAntrianTotal>$kuota){
                                                            ...
                                                            if($ValidasiJenisKunjungan!=="Valid"){
                                                                ...
                                                                if($ValidasiNomorReferensi!=="Valid"){
                                                                    ...
                                                                    if($InputAntrian){
                                                                        if($ws_bpjs=="0"){
                                                                            $_SESSION['NotifikasiSwal']="Tambah Antrian Berhasil";
                                                                            echo "<span class='text-success' id='NotifikasTambahAntrianManualBerhasil'>Success</span><br>";
                                                                            echo "<span class='text-success' id='UrlBack'>index.php?Page=Antrian&Sub=DetailAntrian&KodeBooking=$kodebooking&tanggal=$tanggal</span>";
                                                                        }else{
                                                                        ...
                                                                        echo '
                                                                            <br>
                                                                            Nomor Antrian : '.$NoAntrian.'<br>
                                                                            Kode Booking : '.$kodebooking.'<br>
                                                                            ID Pasien : '.$id_pasien.'<br>
                                                                            Nama Pasien : '.$nama.'<br>
                                                                            Nomor Kartu : '.$nomorkartu.'<br>
                                                                            NIK : '.$nik.'<br>
                                                                            Nomor TLP : '.$notelp.'<br>
                                                                        ';
                                                                    }
