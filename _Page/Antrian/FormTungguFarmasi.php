    ...
    <div class="modal-body">   
        ...
        <div class="row mb-3">
            <div class="col col-md-12">
                <dt>Keterangan</dt>
                Dengan melakukan update data ini maka anda telah menyatakan bahwa pasien sudah memiliki resep yang siap dikirim ke bagian farmasi.
            </div>
        </div>
        <div class="row mb-3">
            <div class="col col-md-12" id="NotifikasiTungguFarmasi">
    ...
    <div class="modal-footer bg-primary">
        <div class="row">
            <div class="col col-md col-12 text-center">
                <button type="button" class="btn btn-sm btn-success mr-2" id="KonfirmasiTungguFarmasi">
