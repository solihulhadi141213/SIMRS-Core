<?php
    ...
    $CekAdaBerapa = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM antrian WHERE tanggal_kunjungan='$tanggal' AND pembayaran='$Pembayaran'"));
                                                    ...
                                                    if($JumlahAntrianTotal>$kuota){
                                                        ...
                                                        if($InputAntrian){
                                                            ...
                                                            if($codeWsBpjs==200){
                                                                ...
                                                                echo "<span class='text-success' id='NotifikasTambahAntrianManualBerhasil'>Pendaftaran Berhasil</span><br>";
                                                                ...
                                                                echo "<span class='text-danger' id='NotifikasTambahAntrianManualBerhasil'>Pendaftaran gagal dilakukan!</span><br>";
                                                                echo "<dt>Pesan :</dt> $err <br>";
                                                            }
                                                        }else{
