...
<div class="row mb-2">
    ...
    <div class="col-1"><small>:</small></div>
    <div class="col-6"><small class="text-muted"><?php echo $kode_mendagri_1; ?></small></div>
</div>

<div class="row mb-2">
    <div class="col-5"><small>Nama Provinsi</small></div>
    <div class="col-1"><small>:</small></div>
    <div class="col-6"><small class="text-muted"><?php echo $province; ?></small></div>
</div>
...
<div class="row mb-2 mt-3">
    <div class="col-12">
        <div class="alert alert-danger text-center">
            <small>
                <b>PENTING!</b><br>
                Semua data kabupaten, kecamatan, dan desa dalam provinsi ini akan ikut terhapus.<br>
