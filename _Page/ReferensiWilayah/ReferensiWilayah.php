        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="bi bi-map"></i> Wilayah</a>
                    </h5>
                    <p class="m-b-0">Kelola Referensi Wilayah Administrasi Yang Tersedia</p>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-end icon-btn">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            <li>
                                                <a class="dropdown-item modal_download" href="javascript:void(0)" data-id="ICD9">Download / Export</a>
                                            </li>
                                            <li>
                                        ...
                                        <button type="button" class="btn btn-md btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahWilayah" title="Tambah Wilayah">
                                    ...
                                    <table class="table table-hover table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <td align="left"><small><b>Provinsi</b></small></td>
                                                <td align="left"><small><b>Tipe 1</b></small></td>
                                                <td align="left"><small><b>Kabupaten/Kota</b></small></td>
                                                <td align="left"><small><b>Kecamatan</b></small></td>
                                                <td align="left"><small><b>Tipe 2</b></small></td>
                                                <td align="left"><small><b>Desa/Kelurahan</b></small></td>
                                            </tr>
                                        </thead>
                                        <tbody id="tabel_wilayah">
