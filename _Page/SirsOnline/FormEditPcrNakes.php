...
?>
    <input type="hidden" name="id_pcr_nakes" id="id_pcr_nakes" value="<?php echo $id_pcr_nakes; ?>">
    <div class="row mb-3">
        <div class="col-md-4">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8">
            <span id="NotifikasiEditPcrNakes">Pastikan data laporan yang anda input sudah sesuai</span>
        </div>
    </div>
<?php } ?>