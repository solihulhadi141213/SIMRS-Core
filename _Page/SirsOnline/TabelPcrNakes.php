<?php
    ...
    if(empty($keyword_by)){
        ...
        if(empty($keyword)){
            ...
            $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM nakes_pcr WHERE $keyword_by like '%$keyword%'"));
        }
    }
?>
<script>
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-center"><dt>Hasil PCR</dt></th>
            ...
            <tbody>
                    ...
                    if(empty($jml_data)){
                        ...
                        if(empty($keyword_by)){
                            ...
                            if(empty($keyword)){
                                ...
                                $query = mysqli_query($Conn, "SELECT*FROM nakes_pcr WHERE $keyword_by like '%$keyword%' ORDER BY $OrderBy $ShortBy LIMIT $posisi, $batas");
                            }
                        }
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left">
                            <i class="ti ti-calendar"></i> <?php echo "$FormatTanggal1"; ?>
                        </td>
                        <td class="text-left">
                            <i class="icofont-doctor-alt"></i> <?php echo "$nama_nakes"; ?><br>
                            <small title="Kategori Nakes">
                                <i class="ti ti-tag"></i> <?php echo "$kategori_nakes"; ?>
                            </small>
                        </td>
                        <td class="text-left">
                            <?php
                                if($hasil_pcr=="Positif"){
                                    echo '<span class="text-danger"><i class="ti ti-plus"></i> Positif</span>';
                                }else{
                                    if($hasil_pcr=="Negatif"){
                                        echo '<span class="text-success"><i class="ti ti-minus"></i> Negatif</span>';
                                    }else{
                                        echo '<span class="text-secondary"><i class="ti ti-timer"></i> Menunggu</span>';
                                    }
                                }
                            ?><br>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="javascript:void(0);" class="btn btn-sm btn-outline-secondary" title="Detail PCR Nakes"  data-toggle="modal" data-target="#ModalDetailHasilPcrNakes" data-id="<?php echo "$id_nakes_pcr"; ?>">
                                    <i class="ti ti-info-alt"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn btn-sm btn-outline-secondary" title="Edit PCR Nakes" data-toggle="modal" data-target="#ModalEditHasilPcrNakes" data-id="<?php echo "$id_nakes_pcr"; ?>">
                                    <i class="ti ti-pencil"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn btn-sm btn-outline-secondary" title="Hapus PCR Nakes" data-toggle="modal" data-target="#ModalHapusHasilPcrNakes" data-id="<?php echo "$id_nakes_pcr"; ?>">
