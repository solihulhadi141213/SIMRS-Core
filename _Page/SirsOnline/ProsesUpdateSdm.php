            ...
            if (!is_numeric($jumlah_eksisting)) {
                ...
                if (!is_numeric($jumlah)) {
                    ...
                    if (!is_numeric($jumlah_diterima)) {
                        ...
                        $KirimData=UpdateSdmSirsOnline($x_id_rs,$password_sirs_online,$url_sirs_online,$json);
                        ...
                        if($status=="200"){
                            $MenyimpanLog=getSaveLog($Conn,$WaktuLog,$SessionNama,"Update Nakes Sirs Online","Nakes",$SessionIdAkses,$LogJsonFile);
                            if($MenyimpanLog=="Berhasil"){
                                echo '<span class="text-success" id="NotifikasiUpdateSdmBerhasil">Success</span>';
                            }else{
                                echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                            }
                        }else{
                            echo '<span class="text-danger">Update Data Nakes Gagal!<br> Pesan : '.$message.'</span>';
                        }
                    }
                }
            }
