        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="ti-world"></i> Site Map</a>
                    </h5>
                    <p class="m-b-0">Kelola data site map (peta situs) pada website</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-header border-info">
                                <form action="javascript:void(0);" id="BatasPencarian">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <select name="keyword_by" id="keyword_by" class="form-control">
                                                ...
                                                <?php
                                                    ...
                                                    $url=urlServiceInline('Info Sitemap');
                                                    $KirimData = array(
                                                        'api_key' => $api_key,
                                                        'keyword_by' => "",
                                                        'keyword' => "",
                                                            ...
                                                            if(!empty($Kolom)){
                                                                ...
                                                                foreach ($GetKolom as $value){
                                                                    ...
                                                                    if($nama_kolom=="tanggal"){
                                                                        ...
                                                                        if($nama_kolom=="url_site"){
                                                                            $NamaBantuan="URL";
                                                                            echo '<option value="'.$nama_kolom.'">'.$NamaBantuan.'</option>';
                                                                        }else{
                                                                            if($nama_kolom=="priority_site"){
                                                                                $NamaBantuan="Priority Site";
                                                                                echo '<option value="'.$nama_kolom.'">'.$NamaBantuan.'</option>';
                                                                            }else{
                                                                                if($nama_kolom=="label"){
                                                                                    $NamaBantuan="Label";
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <a href="javascript:void(0);" class="btn btn-sm btn-block btn-primary" data-toggle="modal" data-target="#ModalTambahSitemap">
                                                <i class="ti-plus text-white"></i> Tambah Sitemap
                                            </a>
                                        </div>
                                    </div>
                                </form>
