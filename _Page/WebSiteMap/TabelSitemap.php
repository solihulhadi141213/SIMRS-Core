<?php
    ...
    $UrlInfo=urlService('Info Sitemap');
    $UrlList=urlService('List Sitemap');
    //keyword
                            ...
                            if($code!==200){
                                ...
                                if(empty($JumlahBaris)){
                                    ...
                                    foreach($list_data as $value){
                                        $id_web_sitemap=$value['id_web_sitemap'];
                                        $tanggal=$value['tanggal'];
                                        $url_site=$value['url_site'];
                                        $priority_site=$value['priority_site'];
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left">
                            <?php
                                echo '<dt>'.$label.'</dt>';
                                echo '<a href="'.$url_site.'" target="_blank">';
                                echo '  <small class="text-muted">'.$url_site.'</small>';
                                echo '</a>';
                            ?>
                        </td>
                        <td class="text-left">
                            <?php
                                echo '<dt>'.$priority_site.'</dt>';
                            ?>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="btn-group dropdown-split-inverse">
                                ...
                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(107px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalViewPage" data-id="<?php echo "$id_web_sitemap"; ?>">
                                        <i class="ti-desktop"></i> View
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalEditSitemap" data-id="<?php echo "$id_web_sitemap"; ?>">
                                        <i class="ti-pencil"></i> Edit
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalHapusSitemap" data-id="<?php echo "$id_web_sitemap"; ?>">
