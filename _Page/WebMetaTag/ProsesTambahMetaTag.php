<?php
    ...
    $UrlTambahMetaTag=urlService('Add Meta Tag');
                ...
                if(empty($_POST['Deskripsi'])){
                    ...
                    if(empty($_POST['Author'])){
                        ...
                        if(empty($_POST['JudulHalaman'])){
                            ...
                            //Mulai CURL
                            $ch = curl_init();
                            curl_setopt($ch,CURLOPT_URL, "$UrlTambahMetaTag");
                            ...
                            if(!empty($err)){
                                ...
                                if($code==200){
                                    echo '<span class="text-success" id="NotifikasiTambahMetaTagBerhasil">Success</span>';
                                }else{
