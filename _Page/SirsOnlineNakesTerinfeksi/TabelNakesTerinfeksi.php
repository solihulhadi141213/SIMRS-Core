<?php
    ...
    if(empty($keyword_by)){
        if(empty($keyword)){
            ...
            $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM nakes_terinfeksi WHERE id_nakes_pcr like '%$keyword%' OR nama like '%$keyword%' OR tanggal like '%$keyword%' OR kategori like '%$keyword%' OR status like '%$keyword%'"));
        }
    }else{
        if(empty($keyword)){
            $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM nakes_terinfeksi"));
                        ...
                        if(empty($jml_data)){
                            ...
                            if(empty($keyword_by)){
                                if(empty($keyword)){
                                    ...
                                    $query = mysqli_query($Conn, "SELECT*FROM nakes_terinfeksi WHERE id_nakes_pcr like '%$keyword%' OR nama like '%$keyword%' OR tanggal like '%$keyword%' OR kategori like '%$keyword%' OR status like '%$keyword%' ORDER BY $OrderBy $ShortBy LIMIT $posisi, $batas");
                                }
                            }else{
                                if(empty($keyword)){
                                    $query = mysqli_query($Conn, "SELECT*FROM nakes_terinfeksi ORDER BY $OrderBy $ShortBy LIMIT $posisi, $batas");
