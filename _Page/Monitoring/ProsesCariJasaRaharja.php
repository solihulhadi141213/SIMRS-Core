<?php
    ...
    $URLUtama=$url_vclaim;
    $URLKatalog="monitoring/JasaRaharja/JnsPelayanan/$JenisPelayanan/tglMulai/$Tgl1/tglAkhir/$Tgl1";
    ...
    if(empty($Jumlah)){
        ...
        $no=1;
        for($a=0; $a<$Jumlah; $a++){
            $noSEP=$list[$a]['sep']['noSEP'];
            $tglSEP=$list[$a]['sep']['tglSEP'];
            $noRegister=$list[$a]['jasaRaharja']['noRegister'];
            $tglKejadian=$list[$a]['jasaRaharja']['tglKejadian'];
            echo '<tr>';
            echo '  <td align="center">'.$no.'</td>';
            echo '  <td align="left">';
            echo '      <dt>'.$noSep.'</dt>';
            echo '  </td>';
            echo '  <td align="left">'.$noRegister.'</td>';
            echo '  <td align="left">'.$tglKejadian.'</td>';
