<?php
    ...
    if(empty($_POST['TanggalSep'])){
        $TanggalSep="";
    }else{
        $TanggalSep=$_POST['TanggalSep'];
    }
    ...
    $URLUtama=$url_vclaim;
    $URLKatalog="Monitoring/Kunjungan/Tanggal/$TanggalSep/JnsPelayanan/$JenisPelayanan";
    ...
    if(empty($Jumlah)){
        ...
        for($a=0; $a<$Jumlah; $a++){
            ...
            echo '  <td align="left">'.$tglPlgSep.'</td>';
            echo '</tr>';
        $no++;}
    }
?>