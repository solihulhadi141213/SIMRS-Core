<?php
    ...
    $UrlInfo=urlService('Info Arsip');
    $UrlList=urlService('List Arsip');
    //keyword
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left">
                            <a href="javascript:void(0);" class="text-primary" data-toggle="modal" data-target="#ModalDetailArsip" data-id="<?php echo "$id_arsip"; ?>">
                                <dt><?php echo "$judul"; ?></dt>
                            </a>
                        </td>
                        <td class="text-left"><?php echo "$kategori"; ?></td>
                        <td class="text-center"><?php echo "$TanggalFormat"; ?></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group dropdown-split-inverse">
                                ...
                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(107px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalDetailArsip" data-id="<?php echo "$id_arsip"; ?>">
                                        <i class="ti ti-info-alt"></i> Detail
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalEditArsip" data-id="<?php echo "$id_arsip"; ?>">
                                        <i class="ti-pencil"></i> Edit
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalHapusArsip" data-id="<?php echo "$id_arsip"; ?>">
