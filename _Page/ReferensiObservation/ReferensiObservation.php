        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="bi bi-file-earmark-medical"></i> Referensi Pemeriksaan (<i>Observation</i>)</a>
                    </h5>
                    <p class="m-b-0">Kelola Referensi Pemeriksaan <i>(Observation)</i> Serta <i>Mapping</i> Terhadap Istilah Lokal dan LOINC</p>
                </div>
            </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 text-end icon-btn">
                                            <button type="button" class="btn btn-md btn-icon btn-outline-dark" data-bs-toggle="modal" data-bs-target="#ModalDownload" title="Download Referensi Observation">
                                        ...
                                        <table class="table table-hover table-sm align-middle">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td align="left" class="align-middle"><small><b>Nama Pemeriksaan</b></small></td>
                                                    <td align="left" class="align-middle"><small><b>Kategori</b></small></td>
                                                    <td align="center" class="align-middle"><small><b><i>Result Type</i></b></small></td>
                                                    <td align="left" class="align-middle"><small><b><i>Unit</i></b></small></td>
                                                    <td align="center"><small><b>Opsi</b></small></td>
                                                </tr>
                                            </thead>
                                            <tbody id="tabel_referensi_observation">
