<?php
    ...
    $Url=urlService('Edit Kunjungan');
    //Validasi Form Data
    if(empty($_POST['id_kunjungan'])){
        echo '<span class="text-danger">ID Kunjungan Web Tidak Boleh Kosong</span>';
    }else{
                                    ...
                                    if(empty($_POST['status'])){
                                        ...
                                        if(!empty($err)){
                                            ...
                                            if($code==200){
                                                ...
                                                echo '<span class="text-success" id="NotifikasiEditKunjunganBerhasil">Success</span>';
                                            }else{
