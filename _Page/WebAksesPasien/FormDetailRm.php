<?php
    ...
    if(empty($_POST['id_pasien'])){
        ...
        $DataPasien=getDataPasien('id_pasien',$id_pasien);
        if(empty($DataPasien['id_pasien'])){
            echo '<div class="row">';
            echo '  <div class="col-md-12">';
            echo '      <span class="text-danger">ID Pasien <i>'.$id_pasien.'</i> Tidak Valid!</span>';
            echo '  </div>';
            echo '</div>';
        }else{
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <div class="alert alert-info" role="alert">  
                Berikut ini adalah detail data pasien yang diperoleh dari <i>Database</i> SIMRS.
            </div>
        </div>
    </div>
    <div class="row">
