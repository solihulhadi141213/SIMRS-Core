                                        ...
                                        if(empty($_POST['GetIdKunjungan'])){
                                            ...
                                            if(empty($SettingSatuSehat)){
                                                ...
                                                if(empty($Token)){
                                                    ...
                                                    $response=EditCondition($baseurl_satusehat,$JsonEncode,$Token,$id_condition);
                                                    if(empty($response)){
                                                        ...
                                                        if(empty($JsonData['id'])){
                                                            ...
                                                            $UpdateCondition = mysqli_query($Conn,"UPDATE kunjungan_condition SET 
                                                                ...
                                                                category='$category2',
                                                                clinicalStatus='$clinicalStatus2',
                                                                code_system='$coding_system'
                                                            WHERE id_condition='$id_condition'") or die(mysqli_error($Conn)); 
                                                            if($UpdateCondition){
                                                                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Condition ID","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                if($MenyimpanLog=="Berhasil"){
                                                                    $_SESSION['NotifikasiSwal']="Edit Condition Berhasil";
                                                                    echo '<span class="text-success" id="NotifikasiEditConditionBerhasil">Success</span>';
                                                                }else{
