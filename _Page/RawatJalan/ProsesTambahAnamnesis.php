                            ...
                            if(empty($_POST['dokter'])){
                                ...
                                if(empty($_POST['perawat'])){
                                    ...
                                    if(!empty($id_anamnesis)){
                                        echo '<small class="text-danger">Data Anamnesis Sudah Ada</small>';
                                    }else{
                                        ...
                                        if($hasil){
                                            ...
                                            $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tambah Anamnesis","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                            if($MenyimpanLog=="Berhasil"){
                                                echo '<span class="text-success" id="NotifikasiTambahAnamnesisBerhasil">Success</span>';
                                            }else{
