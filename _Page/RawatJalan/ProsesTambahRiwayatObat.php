                            ...
                            if(empty($_POST['waktu_penggunaan'])){
                                ...
                                if(empty($_POST['tanggal'])){
                                    ...
                                    if(empty($_POST['jam'])){
                                        ...
                                        $entry="INSERT INTO riwayat_penggunaan_obat (
                                            id_pasien,
                                            id_kunjungan,
                                            id_akses,
                                            tanggal_entry,
                                        ...
                                        if($hasil){
                                            ...
                                            $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tambah Riwayat Penggunaan Obat","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                            if($MenyimpanLog=="Berhasil"){
                                                echo '<span class="text-success" id="NotifikasiTambahRiwayatObatBerhasil">Success</span>';
                                            }else{
