<?php
    ...
    if(empty($_POST['GetIdKunjungan'])){
        ...
        if(empty($_POST['resourceId'])){
            echo '<span class="text-danger">Resource Id Tidak Boleh Kosong!</span>';
        }else{
                                                                ...
                                                                if(empty($_POST['status'])){
                                                                    ...
                                                                    if(empty($SettingSatuSehat)){
                                                                        ...
                                                                        if(empty($Token)){
                                                                            ...
                                                                            $response=EditProcedur($baseurl_satusehat,$JsonEncode,$Token,$resourceId);
                                                                            if(empty($response)){
                                                                                ...
                                                                                if(empty($JsonData['id'])){
                                                                                    ...
                                                                                    $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Procedur ID","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                                    if($MenyimpanLog=="Berhasil"){
                                                                                        echo '<span class="text-success" id="NotifikasiEditProcedureBerhasil">Success</span>';
                                                                                    }else{
