    ...
    if(empty($_GET['id_cppt'])){
        ...
        if(empty($_GET['FormatCetak'])){
            ...
            if(empty($_GET['TampilkanHeader'])){
                ...
                $id_cppt=$_GET['id_cppt'];
                $FormatCetak=$_GET['FormatCetak'];
                $TampilkanHeader=$_GET['TampilkanHeader'];
                //Validasi Keberadaan Data
                $id_cppt=getDataDetail($Conn,"cppt",'id_cppt',$id_cppt,'id_cppt');
                if(empty($id_cppt)){
                    ...
                    $status=getDataDetail($Conn,"cppt",'id_cppt',$id_cppt,'status_edukasi');
?>
    <html>
        <Header>
            <title>CPPT</title>
        ...
        <body>
            ...
            <?php } ?>
            <div class="kop">
                <b class="f16">Catatan Perkembangan Pasien Terintegrasi (CPPT) </b>
            </div>
            <div class="kop">
