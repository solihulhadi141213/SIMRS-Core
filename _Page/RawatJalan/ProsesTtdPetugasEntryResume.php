<?php
    ...
    if(empty($_POST['id_kunjungan'])){
        ...
        if(empty($_POST['signature'])){
            ...
            //Buka Data Lama
            $PetugasEntry=getDataDetail($Conn,"resume",'id_kunjungan',$id_kunjungan,'petugas');
            $JsonPetugas=json_decode($PetugasEntry, true);
            $nama=$JsonPetugas['nama'];
            $kategori=$JsonPetugas['kategori'];
            ...
            if($Update){
                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tanda Tangan Petugas Entry Resume","Kunjungan",$SessionIdAkses,$LogJsonFile);
