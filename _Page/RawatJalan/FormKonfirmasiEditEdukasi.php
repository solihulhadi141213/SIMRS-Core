<?php
    ...
    if(empty($_POST['id_edukasi'])){
        ...
        echo '          Data ID Edukasi Tidak Dapat didefinisikan.';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
    ...
    <div class="modal-body">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-danger">
                Untuk melakukan perubahan data edukasi, anda akan diarahkan pada halaman Form Edit Edukasi.<br>
                Silahkan lanjutkan untuk melakukan perubahan.
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-success mr-3" id="SetujuEditEdukasi">
