<?php
    ...
    //Validasi id_allergy tidak boleh kosong
    if(empty($_POST['id_allergy'])){
        echo '<small class="text-danger">ID Allergy tidak boleh kosong</small>';
    }else{
                            ...
                            if(empty($_POST['clinicalStatus'])){
                                ...
                                if(empty($_POST['verificationStatus'])){
                                    ...
                                    if(empty($_POST['category'])){
                                        ...
                                        //Validasi code_alergi_edit tidak boleh kosong
                                        if(empty($_POST['code_alergi_edit'])){
                                            echo '<small class="text-danger">Kategori tidak boleh kosong</small>';
                                        }else{
                                            ...
                                            if(empty($_POST['id_ihs_practitioner'])){
                                                ...
                                                if(empty($SessionIdAkses)){
                                                    ...
                                                    $code_alergi=$_POST['code_alergi_edit'];
                                                    ...
                                                    if(empty($id_ihs)){
                                                        ...
                                                        if($jumlah_dipilih!==$JumlahDipilihValid){
                                                            ...
                                                            if(empty($Token)){
                                                                ...
                                                                $response=EditAllergyIntolerance ($baseurl_satusehat,$Json,$Token,$id_allergy);
                                                                if(empty($response)){
                                                                    ...
                                                                    if(empty($JsonData['id'])){
                                                                        ...
                                                                        $UpdateAlergy= mysqli_query($Conn,"UPDATE kunjungan_alergi SET 
                                                                            raw='$Json',
                                                                            updatetime='$updatetime'
                                                                        WHERE id_allergy='$id_allergy'") or die(mysqli_error($Conn));
                                                                        if($UpdateAlergy){
                                                                            $now=date('Y-m-d H:i:s');
                                                                            $LogJsonFile="../../_Page/Log/Log.json";
                                                                            $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Alergi Kunjungan","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                            if($MenyimpanLog=="Berhasil"){
                                                                                echo '<span class="text-success" id="NotifikasiEditAllergyIntolerancBerhasil">Success</span>';
                                                                            }else{
