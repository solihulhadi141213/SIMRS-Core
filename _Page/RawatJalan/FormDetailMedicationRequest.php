        ...
        <div class="col-md-12 accordion-block">
            <div id="accordion" role="tablist" aria-multiselectable="true">
                <div class="accordion-panel active">
                    <div class="accordion-heading" role="tab" id="HeadingDetailMedicationRequest1">
                        <h3 class="card-title accordion-title">
                            <a class="accordion-msg waves-effect waves-dark scale_active collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_medication_request1" aria-expanded="false" aria-controls="collapse_medication_request1">
                                <dt>A.Data SIMRS</dt>
                            </a>
                        </h3>
                    </div>
                    <div id="collapse_medication_request1" class="panel-collapse in collapse show" role="tabpanel" aria-labelledby="HeadingDetailMedicationRequest1" style="">
                                            ...
                                            <code class="text-secondary">
                                                <?php 
                                                    if(empty($id_medication_req)){
                                                        ...
                                                        echo "<span>$id_medication_req</small>"; 
                                                    }
                                                ?>
                                            </code>
                                        </li>
                    ...
                    <div class="accordion-heading" role="tab" id="HeadingDetailMedicationRequest2">
                        <h3 class="card-title accordion-title">
                            <a class="accordion-msg waves-effect waves-dark scale_active collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_medication_request2" aria-expanded="false" aria-controls="collapse_medication_request2">
                                <dt>B. Satu Sehat</dt>
                            </a>
                        </h3>
                    </div>
                    <div id="collapse_medication_request2" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="HeadingDetailMedicationRequest2" style="">
                        <div class="accordion-content accordion-desc">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-sm btn-block btn-outline-secondary" id="ButtonGetDetailMedicationRequest" value="<?php echo "$id_medication_req"; ?>">
                                        <i class="ti ti-reload"></i> Tampilkan Dari Satu Sehat
                                    </button>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-12" id="GetDetailMedicationRequest">
                                    <div class="row">
...
<?php }} ?>
<script>
    $('#ButtonGetDetailMedicationRequest').click(function(){
        $('#GetDetailMedicationRequest').html("Loading...");
        var id_item_resep =$('#ButtonGetDetailMedicationRequest').val();
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/RawatJalan/FormDetailMedicationRequest2.php',
            data        : {id_item_resep: id_item_resep},
            success     : function(data){
                $('#GetDetailMedicationRequest').html(data);
            }
        });
    });
</script>