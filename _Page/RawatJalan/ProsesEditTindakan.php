                                                ...
                                                if(empty($_POST['isi_BMHP'])){
                                                    ...
                                                    if(empty($_POST['isi_nama_nakes'])){
                                                        ...
                                                        if(empty($_POST['isi_kategori_nakes'])){
                                                            ...
                                                            $Update= mysqli_query($Conn,"UPDATE tindakan SET 
                                                                ...
                                                                alat_medis='$JsonAlkes',
                                                                bmhp='$JsonBmhp',
                                                                nakes='$JsonNakes'
                                                            WHERE id_tindakan='$id_tindakan'") or die(mysqli_error($Conn));
                                                            if($Update){
                                                                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Tindakan","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                if($MenyimpanLog=="Berhasil"){
                                                                    echo '<span class="text-success" id="NotifikasiEditTindakanBerhasil">Success</span>';
                                                                }else{
