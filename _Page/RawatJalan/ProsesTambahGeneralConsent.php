                                                                                ...
                                                                                if(empty($_POST['HasilPemeriksaanPenunjang2'])){
                                                                                    ...
                                                                                    if(empty($_POST['FasyankesRujukan'])){
                                                                                        ...
                                                                                        if(!empty($id_general_consent)){
                                                                                            echo '<span class="text-danger"> Data sudah ada, tidak boleh duplikat!</span>';
                                                                                        }else{
                                                                                            ...
                                                                                            //Format Tanggal
                                                                                            $tanggal="$tanggal $jam";
                                                                                            //Membuat ID General Consent
                                                                                            $QryGeneralConsentMax=mysqli_query($Conn, "SELECT max(id_general_consent) as maksimal FROM general_consent")or die(mysqli_error($Conn));
                                                                                            while($HasilMax=mysqli_fetch_array($QryGeneralConsentMax)){
                                                                                                $NilaiMax=$HasilMax['maksimal'];
                                                                                            }
                                                                                            $id_general_consent=$NilaiMax+1;
                                                                                            //Membuat JSON
                                                                                            ...
                                                                                            //Simpan Data
                                                                                            $entry="INSERT INTO general_consent (
                                                                                                id_general_consent,
                                                                                                id_pasien,
                                                                                                id_kunjungan,
                                                                                                id_akses,
                                                                                                ...
                                                                                                '$nama_pasien',
                                                                                                '$JsonEncodePetugas',
                                                                                                '$JsonEncodePenanggungJawab',
                                                                                                '$tanggal',
                                                                                                '$JsonEncodeGeneralConsent'
                                                                                            )";
                                                                                            ...
                                                                                            if($hasil){
                                                                                                ...
                                                                                                if($MenyimpanLog=="Berhasil"){
                                                                                                    echo '<span class="text-success" id="NotifikasiTambahGeneralConsentBerhasil">Success</span>';
                                                                                                }else{
