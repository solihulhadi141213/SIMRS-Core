                                        ...
                                        if(empty($_POST['asesmen_nyeri'])){
                                            ...
                                            if(empty($_POST['sarana_transportasi'])){
                                                ...
                                                if($ValidasiSuratRujukan!=="Valid"){
                                                    ...
                                                    $UpdateTriaseIgd= mysqli_query($Conn,"UPDATE triase_igd SET 
                                                        tanggal='$TanggalJamCatat',
                                                        tanggal_jam_masuk='$TanggalJamMasuk',
                                                        triase_igd='$JsonTreaseIgd'
                                                    WHERE id_kunjungan='$id_kunjungan'") or die(mysqli_error($Conn));
                                                    if($UpdateTriaseIgd){
                                                        $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Update Trease Dan Igd","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                        if($MenyimpanLog=="Berhasil"){
                                                            echo '<span class="text-success" id="NotifikasiEditTriaseDanIgdBerhasil">Success</span>';
                                                        }else{
