    ...
    <div class="modal-body border-0 pb-0 mb-4">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-primary">
                <span id="">
                    Apakah anda yakin akan membuat SEP berdasarkan data Kunjungan ini?
                </span>
            </div>
        </div>
    </div>
    <div class="modal-footer bg-info">
        <div class="row">
            <div class="col-md-12 mb-3">
                <a href="index.php?Page=RawatJalan&Sub=BuatSep&id=<?php echo "$id_kunjungan";?>" class="btn btn-md btn-inverse mt-2 ml-2">
                    <i class="ti-check-box"></i> Ya, Buat
                </a>
