                                    ...
                                    if(empty($_POST['diagnosa'])){
                                        ...
                                        if(empty($Explode[0])){
                                            ...
                                            if(empty($Explode[1])){
                                                ...
                                                $entry="INSERT INTO diagnosis_pasien (
                                                    id_pasien,
                                                    id_kunjungan,
                                                    id_akses,
                                                    nama_pasien,
                                                ...
                                                if($hasil){
                                                    ...
                                                    $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tambah Diagnosa Pasien","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                    if($MenyimpanLog=="Berhasil"){
                                                        echo '<span class="text-success" id="NotifikasiTambahDiagnosaBerhasil">Success</span>';
                                                    }else{
