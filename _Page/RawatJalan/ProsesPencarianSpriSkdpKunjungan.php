<?php
    ...
    if(empty($_POST['PutNomorKartu'])){
        ...
        $tanggal_kontrol=date('Y-m-d');
        $NomorKartu=$_POST['PutNomorKartu'];
        //Pecah Tanggal
...
<script>
    ...
    $('.CheckSuratKontrol').click(function(){
        ...
        //Menambahkan Ke Form
        $('#skdp').val(GetNomorSurat);
        //Menutup Modal
        $('#ModalCariSpriSkdpPendaftaranKunjungan').modal('hide');
    });
</script>