                                        ...
                                        if(empty($_POST['tipe_value'])){
                                            ...
                                            if(empty($_POST['IdPractitioner'])){
                                                ...
                                                if(empty($_POST['id_kunjungan_observation'])){
                                                    echo '<span class="text-danger">ID Kunjungan Observation Tidak Boleh Kosong!</span>';
                                                }else{
                                                    if(empty($_POST['UpdateObservationResource'])){
                                                        $UpdateObservationResource="";
                                                    }else{
                                                        $UpdateObservationResource=$_POST['UpdateObservationResource'];
                                                    }
                                                    //Membuat Variabel
                                                    ...
                                                    if($ValidasiValue!=="Valid"){
                                                        ...
                                                        if($UpdateObservationResource!=="Ya"){
                                                            if(empty($_POST['id_observation'])){
                                                                $id_observation="";
                                                            }else{
                                                                $id_observation=$_POST['id_observation'];
                                                            }
                                                            $UpdateObservation = mysqli_query($Conn,"UPDATE kunjungan_observation SET 
                                                                id_observation='$id_observation',
                                                                id_pasien='$id_pasien',
                                                                id_kunjungan='$id_kunjungan',
                                                                id_ihs='$id_ihs',
                                                                id_encounter='$id_encounter',
                                                                id_ihs_practitioner='$IdPractitioner',
                                                                status='$ObservationStatus',
                                                                category='$category',
                                                                observation_code='$KodeCodeSystemLoinc',
                                                                observation_display='$NamaCodeSystemLoinc',
                                                                tipe_value='$tipe_value',
                                                                raw_value='$RawValueEncode',
                                                                raw_interpertation='$InterpertationJson'
                                                            WHERE id_kunjungan_observation='$id_kunjungan_observation'") or die(mysqli_error($Conn)); 
                                                            if($UpdateObservation){
                                                                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Observation ID","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                if($MenyimpanLog=="Berhasil"){
                                                                    echo '<span class="text-success" id="NotifikasiEditObservationBerhasil">Success</span>';
                                                                }else{
                                                            ...
                                                            if(empty($SettingSatuSehat)){
                                                                ...
                                                                if(empty($Token)){
                                                                    ...
                                                                    if(empty($_POST['id_observation'])){
                                                                        ...
                                                                        $id_observation=$_POST['id_observation'];
                                                                        $response=EditObservation($baseurl_satusehat,$JsonEncode,$Token,$id_observation);
                                                                    }
                                                                    if(empty($response)){
                                                                        ...
                                                                        if(empty($JsonData['id'])){
                                                                            ...
                                                                            WHERE id_kunjungan_observation='$id_kunjungan_observation'") or die(mysqli_error($Conn)); 
                                                                            if($UpdateObservation){
                                                                                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Obsertvation ID","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                                if($MenyimpanLog=="Berhasil"){
                                                                                    echo '<span class="text-success" id="NotifikasiEditObservationBerhasil">Success</span>';
                                                                                }else{
                                                                                    echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
