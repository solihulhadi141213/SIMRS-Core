<?php
    ...
    if(empty($_GET['id_persetujuan_tindakan'])){
        ...
        if(empty($_GET['FormatCetak'])){
            ...
            if(empty($_GET['TampilkanHeader'])){
                ...
                $id_persetujuan_tindakan=$_GET['id_persetujuan_tindakan'];
                ...
                if(empty($id_persetujuan_tindakan)){
                    ...
                    $id_akses=getDataDetail($Conn,"persetujuan_tindakan",'id_persetujuan_tindakan',$id_persetujuan_tindakan,'id_akses');
...
?>
    <html>
        <Header>
            <title>Persetujuan Tindakan</title>
        ...
        <body>
            ...
            <?php } ?>
            <div class="kop">
                <b class="f16">PERSETUJUAN TINDAKAN</b>
            </div>
            <div class="kop">
                <table class="data" cellspacing="0px">
                    ...
                    <tr>
                        <td></td>
                        <td>A.1</td>
                        <td>ID Persetujuan Tindakan</td>
                        <td>:</td>
                        <td><?php echo "$id_persetujuan_tindakan"; ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>A.2</td>
