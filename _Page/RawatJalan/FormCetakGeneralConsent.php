...
?>
    ...
    <div class="modal-body">
        ...
        <div class="row mb-3">
            <div class="col-md-12 mb-2">
                Tamplikan Tanda Tangan?<br>
                <input type="radio" id="TampilkanTandaTanganYa" name="TampilkanTandaTangan" value="Ya">
                <label for="TampilkanTandaTanganYa"><small>Ya, Tampilkan</small></label>
                <input type="radio" id="TampilkanTandaTanganTidak" name="TampilkanTandaTangan" value="Tidak">
                <label for="TampilkanTandaTanganTidak"><small>Tidak</small></label>
            </div>
        </div>
    </div>
