...
?>
    <input type="hidden" name="id_cppt" id="id_edukasi" class="form-control" value="<?php echo "$id_cppt"; ?>">
    <div class="modal-body">
        <div class="row mb-3">
            <div class="col-md-12 mb-2">
                Berikut ini adalah parameter mode cetak untuk data CPPT secara parsial. Silahkan lakukan pengaturan mode cetak yang anda inginkan.
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12 mb-2">
