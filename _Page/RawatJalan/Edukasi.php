...
?>
    <input type="hidden" name="GetIdKunjunganEdukasi" id="GetIdKunjunganEdukasi" value="<?php echo "$id_kunjungan"; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            <h4>
                                                <i class="ti ti-info-alt"></i> Lembar Edukasi Pasien
                                            </h4>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-sm btn-outline-dark" id="ListEdukasi">
                                                    <i class="icofont-list"></i> List
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-dark" id="TambahEdukasi">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-dark" data-toggle="modal" data-target="#ModalCetakEdukasiAll" data-id="<?php echo "$id_kunjungan"; ?>">
                                ...
                                <div class="card-body" id="KontenEdukasi">
