<?php
    ...
    //Validasi id_persetujuan_tindakan tidak boleh kosong
                                                                                            ...
                                                                                            if(empty($_POST['isi_tindakan'])){
                                                                                                ...
                                                                                                if(empty($_POST['konsekuensi'])){
                                                                                                    ...
                                                                                                    if(empty($_POST['persetujuan'])){
                                                                                                        ...
                                                                                                        //Buka Data Lama
                                                                                                        $GetDokter=getDataDetail($Conn,"persetujuan_tindakan",'id_persetujuan_tindakan',$id_persetujuan_tindakan,'dokter');
                                                                                                        $GetPemberiPernyataan=getDataDetail($Conn,"persetujuan_tindakan",'id_persetujuan_tindakan',$id_persetujuan_tindakan,'pemberi_pernyataan');
                                                                                                        $GetSaksi=getDataDetail($Conn,"persetujuan_tindakan",'id_persetujuan_tindakan',$id_persetujuan_tindakan,'saksi');
                                                                                                        //Json Decode
                                                                                                        $JsonDokter=json_decode($GetDokter, true);
                                                                                                        $JsonPemberiPernyataan =json_decode($GetPemberiPernyataan, true);
                                                                                                        $JsonSaksi=json_decode($GetSaksi, true);
                                                                                                        //Buka TTD
                                                                                                        ...
                                                                                                        $Update= mysqli_query($Conn,"UPDATE persetujuan_tindakan SET 
                                                                                                            nama_petugas='$petugas_entry',
                                                                                                            dokter='$JsonDokter',
                                                                                                            pemberi_pernyataan='$JsonPemberiPernyataan',
                                                                                                            tanggal_entry='$tanggal_entry',
                                                                                                            tanggal_penjelasan='$tanggal_penjelasan',
                                                                                                            persetujuan='$persetujuan',
                                                                                                            tindakan='$JsonTindakan',
                                                                                                            konsekuensi='$konsekuensi',
                                                                                                            saksi='$JsonSaksi'
                                                                                                        WHERE id_persetujuan_tindakan='$id_persetujuan_tindakan'") or die(mysqli_error($Conn));
                                                                                                        if($Update){
                                                                                                            $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Persetujuan Tindakan","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                                                                            if($MenyimpanLog=="Berhasil"){
                                                                                                                echo '<span class="text-success" id="NotifikasiEditPersetujuanTindakanBerhasil">Success</span>';
                                                                                                            }else{
