                                        ...
                                        if(empty($_POST['dokter'])){
                                            ...
                                            if(empty($_POST['status_decubitus'])){
                                                ...
                                                if(empty($id_screening)){
                                                    echo '<small class="text-danger">Data Tidak Valid/Tidak Ditemukan Pada Database</small>';
                                                }else{
                                                    //Json Nama Petugas
                                                    $nama_petugas=Array (
                                                    ...
                                                    $UpdateScreening= mysqli_query($Conn,"UPDATE screening SET 
                                                    ...
                                                    if($UpdateScreening){
                                                        $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Edit Screening","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                        if($MenyimpanLog=="Berhasil"){
                                                            echo '<span class="text-success" id="NotifikasiEditScreeningBerhasil">Success</span>';
                                                        }else{
