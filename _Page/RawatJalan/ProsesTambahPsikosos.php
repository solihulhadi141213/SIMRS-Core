                                            ...
                                            if(empty($_POST['status_psikologi'])){
                                                ...
                                                if(!empty($id_psikosos)){
                                                    ...
                                                    if($hasil){
                                                        ...
                                                        $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tambah Psikososial","Kunjungan",$SessionIdAkses,$LogJsonFile);
                                                        if($MenyimpanLog=="Berhasil"){
                                                            echo '<span class="text-success" id="NotifikasiTambahPsikososBerhasil">Success</span>';
                                                        }else{
