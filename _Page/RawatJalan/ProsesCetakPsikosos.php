...
?>
    <html>
        ...
        <body>
            ...
            <?php } ?>
            <div class="kop">
                <b class="f16">PSIKOLOGI SOSIAL DAN SPIRITUAL</b>
            </div>
            <div class="kop">
                <table class="data" cellspacing="0px">
                    ...
                    <tr>
                        <td></td>
                        <td>A.5</td>
                        <td>Tanggal & Jam Wawancara</td>
                        <td>:</td>
                        <td><?php echo "$FormatTanggal_wawancara"; ?></td>
                    </tr>
                </table>
            </div>
        </body>
