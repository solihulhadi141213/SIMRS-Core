<?php
    ...
    if(empty($_POST['id_riwayat_penggunaan_obat'])){
        ...
        echo '          ID Riwayat Tidak Boleh Kosong!';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
        ...
        $FormatTanggalPenggunaan=date('Y-m-d',$strtotime2);
        $FormatJamPenggunaan=date('H:i',$strtotime2);
        //Buka Obat
...
?>
    <input type="hidden" name="id_riwayat_penggunaan_obat" id="id_riwayat_penggunaan_obat" class="form-control" value="<?php echo "$id_riwayat_penggunaan_obat"; ?>">
    <div class="modal-body">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-12">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col col-md-8">
                        <input type="text" name="nama_obat" id="nama_obat" class="form-control" value="<?php echo "$NamaObat"; ?>">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col col-md-4">
                    ...
                    <div class="col col-md-8">
                        <input type="text" name="bentuk_sediaan" id="bentuk_sediaan" class="form-control" value="<?php echo "$Sediaan"; ?>">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col col-md-8">
                        <input type="text" name="aturan_pakai" id="aturan_pakai" class="form-control" value="<?php echo "$aturan_pakai"; ?>">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col col-md-8">
                        <input type="text" name="waktu_penggunaan" id="waktu_penggunaan" class="form-control" value="<?php echo "$WaktuPenggunaan"; ?>">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col col-md-8">
                        <input type="date" name="tanggal" id="tanggal" class="form-control" value="<?php echo "$FormatTanggalPenggunaan"; ?>">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col col-md-8">
                        <input type="time" name="jam" id="jam" class="form-control" value="<?php echo "$FormatJamPenggunaan"; ?>">
        ...
        <div class="row mb-3">
            <div class="col-md-12" id="NotifikasiEditRiwayatObat">
