    ...
    if(empty($_POST['id_kunjungan'])){
        ...
        if(empty($_POST['id'])){
            ...
            if($UpdateGeneralConsent){
                $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Hapus Penerima Informasi General Consent","Kunjungan",$SessionIdAkses,$LogJsonFile);
                if($MenyimpanLog=="Berhasil"){
                    echo '<span class="text-success" id="NotifikasiHapusPenerimaInformasiGeneralConsentBerhasil">Success</span>';
                }else{
                    echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                }
            }else{
                echo '<span class="text-danger">Terjadi kesalahan pada saat menghapus pihak penerima informasi pasien!</span><br>';
            }
        }
    }
?>