                            ...
                            if(empty(json_decode($FileDekompresi, true))){
                                ...
                                if(empty($FileDekompresiJson['faskes'])){
                                    ...
                                    for($a=0; $a<$Jumlah; $a++){
                                        ...
                                        echo '      <small class="SetKodePpkPerujuk">'.$kode.'-'.$nama.'</small>';
                                        echo '  </a>';
                                        echo '</div>';
                                    }
                                }
...
<script>
    ...
    $(".SetKodePpkPerujuk").click(function() {
        ...
        var explode =KodePpkPerujukTerpilih.split('-');
        var kode_faskes=explode['0'];
        var nama_faskes=explode['1'];
        //Masukan ke Form
        $('#kode_perujuk').val(kode_faskes);
        $('#nama_fayankes_perujuk').val(nama_faskes);
        //Tutup Modal
