                ...
                if(empty($_POST['status_loker'])){
                    ...
                    if(empty($_POST['posisi_jabatan'])){
                        ...
                        if(empty($_POST['deskripsi_loker'])){
                            ...
                            //Validasi id_loker tidak boleh kosong
                            if(empty($_POST['id_loker'])){
                                echo '<span class="text-danger">ID Loker Tidak Boleh Kosong</span>';
                            }else{
                                ...
                                if(!empty($err)){
                                    ...
                                    if($code!==200){
                                        ...
                                        $_SESSION['NotifikasiSwal']="Edit Loker Berhasil";
                                        echo '<span class="text-success" id="NotifikasiEditLokerBerhasil">Success</span>';
                                    }
                                }
                                }
                        }
