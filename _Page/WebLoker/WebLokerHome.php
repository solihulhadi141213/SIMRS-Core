        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="ti ti-bag"></i> Lowongan Kerja</a>
                    </h5>
                    <p class="m-b-0">Kelola data lowongan kerja yang dipublikasikan pada halaman website</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-header border-info">
                                <form action="javascript:void(0);" id="BatasPencarian">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <select name="keyword_by" id="keyword_by" class="form-control">
                                                ...
                                                <?php
                                                    ...
                                                    $url=urlServiceInline('Info Loker');
                                                    $KirimData = array(
                                                        'api_key' => $api_key,
                                                        'keyword_by' => "",
                                                        'keyword' => "",
                                                        ...
                                                        if($code==200){
                                                            ...
                                                            if(!empty($Kolom)){
                                                                ...
                                                                foreach ($GetKolom as $value){
                                                                    ...
                                                                    if($nama_kolom=="datetime_post"){
                                                                        $NamaEvent="Tanggal Post";
                                                                        echo '<option value="'.$nama_kolom.'">'.$NamaEvent.'</option>';
                                                                    }else{
                                                                        if($nama_kolom=="datetime_expired"){
                                                                            $NamaEvent="Tanggal Expired";
                                                                            echo '<option value="'.$nama_kolom.'">'.$NamaEvent.'</option>';
                                                                        }else{
                                                                            if($nama_kolom=="posisi_jabatan"){
                                                                                $NamaEvent="Posisi/Jabatan";
                                                                                echo '<option value="'.$nama_kolom.'">'.$NamaEvent.'</option>';
                                                                            }else{
                                                                                if($nama_kolom=="status_loker"){
                                                                                    $NamaEvent="Satatus";
                                                                                    echo '<option value="'.$nama_kolom.'">'.$NamaEvent.'</option>';
                                                                                }else{
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <a href="index.php?Page=WebLoker&Sub=TambahLoker" class="btn btn-sm btn-block btn-primary">
                                                <i class="ti-plus text-white"></i> Tambah Lowongan
                                            </a>
                                        </div>
                                    </div>
                                </form>
