<?php
    ...
    $url=urlService('Edit Laman Mandiri');
    //Validasi id_laman tidak boleh kosong
                        ...
                        if(empty($_POST['isi_laman'])){
                            ...
                            if(!empty($err)){
                                ...
                                if($code!==200){
                                    ...
                                    $_SESSION['NotifikasiSwal']="Edit Laman Berhasil";
                                    echo '<span class="text-success" id="NotifikasiEditLamanBerhasil">Success</span>';
                                }
                            }
                        }
                    }
