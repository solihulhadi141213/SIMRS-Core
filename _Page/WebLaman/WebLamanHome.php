        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="ti ti-file"></i> Laman Mandiri</a>
                    </h5>
                    <p class="m-b-0">Kelola data laman mandiri pada website</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-header border-info">
                                <form action="javascript:void(0);" id="BatasPencarian">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <select name="keyword_by" id="keyword_by" class="form-control">
                                                ...
                                                <?php
                                                    ...
                                                    $url=urlServiceInline('Info Laman Mandiri');
                                                    $KirimData = array(
                                                        'api_key' => $api_key,
                                                    );
                                                            ...
                                                            if(!empty($Kolom)){
                                                                ...
                                                                foreach ($GetKolom as $value){
                                                                    ...
                                                                    if($nama_kolom=="tanggal"){
                                                                        ...
                                                                        if($nama_kolom=="judul"){
                                                                            $NamaKolom="Judul Halaman";
                                                                            echo '<option value="'.$nama_kolom.'">'.$NamaKolom.'</option>';
                                                                        }else{
                                                                            if($nama_kolom=="penulis"){
                                                                                $NamaKolom="Penulis";
                                                                                echo '<option value="'.$nama_kolom.'">'.$NamaKolom.'</option>';
                                                                            }else{
                                                                                if($nama_kolom=="isi_laman"){
                                                                                    $NamaKolom="Isi Halaman";
                                                                                    echo '<option value="'.$nama_kolom.'">'.$NamaKolom.'</option>';
                                                                                }else{
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <a href="index.php?Page=WebLaman&Sub=TambahLaman" class="btn btn-sm btn-block btn-primary">
                                                <i class="ti-plus text-white"></i> Tambah Halaman
                                            </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div id="TabelLamanMandiri">
                                <!--  menampilkan data Laman Mandiri disini -->
                            </div>
                        </div>
                    </div>
                </div>
