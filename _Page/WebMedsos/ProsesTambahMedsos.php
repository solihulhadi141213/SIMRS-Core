    ...
    if(empty($_POST['nama_medsos'])){
        ...
        if(empty($_POST['url_medsos'])){
            ...
            if(empty($_FILES['img_medsos']['name'])){
                echo '<span class="text-danger">Image/Icon Medsos Tidak Boleh Kosong</span>';
            }else{
                //Validasi Tipe File
                ...
                if($ukuran_gambar>$UkuranMaksimal){
                    ...
                    if($ValidasiGambar!=="Valid"){
                        ...
                        if(!empty($err)){
                            ...
                            if($code==200){
                                echo '<span class="text-success" id="NotifikasiTambahMedsosBerhasil">Success</span>';
                            }else{
