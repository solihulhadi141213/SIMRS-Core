<?php
    ...
    echo '
        ...
        <div class="row mb-2">
            <div class="col-4"><small>Nomor NIK/KTP</small></div>
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text-muted">'.$nik_praktisi.'</small>
            </div>
        </div>
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text-muted">'.$kontak_praktisi.'</small>
            </div>
        </div>
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text-muted">'.$email_praktisi.'</small>
            </div>
        </div>
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text-muted">'.$id_akses.'</small>
            </div>
        </div>
        <div class="row mb-2">
            ...
            <div class="col-1"><small>:</small></div>
            <div class="col-7">
                <small class="text-muted">'.$id_dokter.'</small>
            </div>
        </div>
    ';
?>
