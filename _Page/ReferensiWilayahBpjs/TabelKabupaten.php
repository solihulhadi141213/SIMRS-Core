<?php
    ...
    $keyword   = trim($_POST['keyword_kabupaten'] ?? '');
    ...
    // URL API
    // =========================================================
    $url = $url_vclaim . "/referensi/kabupaten/propinsi/$kode_prov";
    ...
    foreach ($list as $item) {
        ...
        $id_wilayah_kab = getDataDetail_v2($Conn, 'wilayah', 'kode_bpjs2', $kode, 'id_wilayah');
        ...
        echo '
            <tr>
                ...
                <td><small class="'.$text_color_kab.'">'.$kode.'</small></td>
                <td><small class="'.$text_color_kab.'">'.$nama.'</small></td>
                <td>
                    <button type="button" class="btn btn-sm btn-primary modal_kecamatan" data-nama_prov="' . htmlspecialchars($nama_prov) . '" data-kode_prov="' . htmlspecialchars($kode_prov) . '" data-nama_kab="' . htmlspecialchars($nama) . '" data-kode_kab="' . htmlspecialchars($kode) . '">
