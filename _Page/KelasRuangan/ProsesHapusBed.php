<?php
    ...
    if(empty($_POST['id_ruang_rawat'])){
        ...
        if($HapusRuangan){
            ...
            $nama_log="Hapus Data Tempat Tidur Berhasil";
            $kategori_log="Kelas Ruangan";
            include "../../_Config/Log.php";
            echo '<span id="NotifikasiHapusBedBerhasil">Berhasil</span>';
        }else{
            echo '<span id="NotifikasiHapusBedBerhasil">Hapus gagal</span>';
        }
    }
?>
