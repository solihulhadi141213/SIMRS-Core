                        ...
                        if(empty($_POST['kelas'])){
                            ...
                            if(empty($_POST['ruangan'])){
                                ...
                                if(empty($_POST['id_ruang_rawat'])){
                                    echo '<tr>';
                                    echo '  <td align="center" colspan="6">Siahkan Pilih Bed Terlebih Dulu</td>';
                                    echo '</tr>';
                                }else{
                                    ...
                                    $no=1;
                                    $query = mysqli_query($Conn, "SELECT*FROM kunjungan_utama WHERE kelas='$kelas' AND ruangan='$ruangan' AND id_kasur='$id_ruang_rawat' AND status='Terdaftar' ORDER BY id_kunjungan ASC");
