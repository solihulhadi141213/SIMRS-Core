<?php
    ...
    if(empty($_POST['PilihKelas'])){
        ...
        if(empty($_POST['PilihRuangan'])){
            ...
            echo '  <div class="row">';
            echo '      <div class="col-md-12 mb-3 text-danger">';
            echo '          Silahkan Pilih Ruangan Terlebih Dulu!!';
            echo '      </div>';
            echo '  </div>';
            echo '</div>';
            echo '<div class="modal-footer bg-primary">';
        ...
        //Membuka data kelas 
        $Qry = mysqli_query($Conn,"SELECT * FROM ruang_rawat WHERE kelas='$kelas' AND ruangan='$ruangan' AND kategori='ruangan'")or die(mysqli_error($Conn));
        $Data = mysqli_fetch_array($Qry);
        $kodekelas = $Data['kodekelas'];
        $kelas = $Data['kelas'];
        $ruangan = $Data['ruangan'];
?>
    <form action="javascript:void(0);" method="POST" id="ProsesTambahBed" autocomplete="off">
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="kategori"><dt>Kategori</dt></label>
                    <input type="text" readonly name="kategori" id="kategori" class="form-control" value="bed" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="tipe" id="tipe" class="form-control">
                        ...
                        <option value="pria">Kusus Pria</option>
                        <option value="wanita">Kusus Wanita</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-12 mb-3" id="NotifikasiTambahBed">
