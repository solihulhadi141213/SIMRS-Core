function ShowData(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/Radix/TabelRadix.php',
...
$(document).ready(function() {
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/Radix/ProsesTambah.php',
            dataType: 'json',
            data    : ProsesTambah,
    ...
    $('#ModalDetail').on('show.bs.modal', function (e) {
        ...
        // Tangkap data-id
        var id_setting_radix = $(e.relatedTarget).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Radix/FormDetail.php',
    ...
    $('#ProsesUjiKoneksi').submit(function(e){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/Radix/ProsesUjiKoneksi.php',
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/Radix/ProsesEdit.php',
            dataType: 'json',
            data    : ProsesEdit,
            success: function(response) {
                var status  = response.status;
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/Radix/ProsesHapus.php',
            dataType: 'json',
            data    : ProsesHapus,
            success: function(response) {
                var status  = response.status;
