<?php
    ...
    $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT id_setting_radix FROM setting_radix"));
        ...
        echo '
            <tr>
                ...
                <td class="text-center">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-outline-dark" data-toggle="modal" data-target="#ModalDetail" data-id="'.$id_setting_radix.'">
                            <i class="ti ti-info"></i>
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-dark" data-toggle="modal" data-target="#ModalEdit" data-id="'.$id_setting_radix.'">
                            <i class="ti ti-pencil"></i>
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-dark" data-toggle="modal" data-target="#ModalHapus" data-id="'.$id_setting_radix.'">
