<?php
    ...
    //Tangkap id_obat_multi
    if(empty($_POST['id_obat_multi'])){
        echo '<div class="row">';
        echo '      <div class="col-md-12 text-center text-danger">';
        echo '          ID Satuan Tidak Boleh Kosong!';
        echo '      </div>';
        echo '</div>';
    }else{
        $id_obat_multi=$_POST['id_obat_multi'];
        //Buka Data Satuan Multi
        $id_obat=getDataDetail($Conn,'obat_satuan','id_obat_multi',$id_obat_multi,'id_obat');
        $SatuanMulti=getDataDetail($Conn,'obat_satuan','id_obat_multi',$id_obat_multi,'satuan');
        $IsiMulti=getDataDetail($Conn,'obat_satuan','id_obat_multi',$id_obat_multi,'isi');
        if(empty($id_obat)){
            echo '<div class="row">';
            echo '      <div class="col-md-12 text-center text-danger">';
...
?>
    <input type="hidden" class="form-control" name="id_obat_multi" id="id_obat_multi" value="<?php echo "$id_obat_multi"; ?>">
    <div class="row mb-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="satuan" id="SatuanMulti" list="ListSatuan" value="<?php echo "$SatuanMulti"; ?>">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="isi" id="IsikemasanMulti" value="<?php echo "$IsiMulti"; ?>">
            <small>
                Stok : 
