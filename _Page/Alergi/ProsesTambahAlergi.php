                ...
                if(empty($SessionIdAkses)){
                    ...
                    if(!empty($ValidasiDuplikat)){
                        ...
                        if($Input){
                            ...
                            $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Tambah Referensi Alergi","Referensi Alergi",$SessionIdAkses,$JsonUrl);
                            if($MenyimpanLog=="Berhasil"){
                                echo '<span class="text-success" id="NotifikasiTambahAlergiBerhasil">Success</span>';
                            }else{
                                echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                            }
                        }else{
                            echo '<span class="text-danger">Tambah Data Referensi Alergi Gagal!</span>';
                        }
                    }
                }
            }
