        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="bi bi-file-earmark-medical"></i> Alergi <i>(Allergies)</i></a>
                    </h5>
                    <p class="m-b-0">
                        Kelola Riwayat Alergi Pasien
                    </p>
                </div>
            </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 text-end icon-btn">
                                            <button type="button" class="btn btn-md btn-icon btn-outline-dark" data-bs-toggle="modal" data-bs-target="#ModalDownload" title="Download Data">
                                        ...
                                        <table class="table table-hover table-sm align-middle">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td align="center"><small><b>Alergi</b></small></td>
                                                    <td align="center"><small><b><i>AllergyIntolerance</i></b></small></td>
                                                </tr>
                                            </thead>
                                            <tbody id="tabel_alergi">
                            ...
                            <div class="card w-100">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <b class="card-title">
                                                <i class="bi bi-info-circle"></i> Riwayat Alergi
                                            </b>
                                        </div>
                                        <div class="col-6 text-end icon-btn">
                                            <button type="button" class="btn btn-md btn-icon btn-dark back_to_data" title="Kembali Ke Data Alergi">
                                                <i class="bi bi-chevron-double-left"></i>
                                            </button>
                                            <button type="button" class="btn btn-md btn-icon btn-outline-dark reload_data" title="Reload Data">
                                                <i class="bi bi-repeat"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body" id="DetailView">
