    ...
    <div class="modal-body border-0 pb-0 mb-4">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-primary">
                <span id="">
                    Apakah anda yakin akan membuat rujukan untuk SEP <?php echo '<dt>'.$sep.'</dt>'; ?> ini?
                </span>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <div class="row">
            <div class="col-md-12 mb-3">
                <a href="javascript:void(0);" class="btn btn-md btn-inverse mt-2 ml-2" id="KonfirmasiPilihSepYa">
