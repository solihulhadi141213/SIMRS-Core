<?php
    ...
    if(!empty($_POST['tanggalRujukan'])){
        $tanggalRujukan=$_POST['tanggalRujukan'];
    }else{
        $tanggalRujukan="";
    }
?>
    ...
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
                ...
                <th class="text-center"><dt>Spesialistik</dt></th>
            </tr>
        </thead>
        <tbody>
            <?php
                ...
                $URLUtama=$url_vclaim;
                $URLKatalog="Rujukan/ListSpesialistik/PPKRujukan/$kodePpkRujukan/TglRujukan/$tanggalRujukan";
                ...
                $no=1;
                for($a=0; $a<$Jumlah; $a++){
                    $kode=$list[$a]['kodeSpesialis'];
                    $nama=$list[$a]['namaSpesialis'];
                    echo '<tr>';
