    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            <?php
                ...
                $URLUtama=$url_vclaim;
                $URLKatalog="referensi/diagnosa/$keyword";
                ...
                for($a=0; $a<$Jumlah; $a++){
                    ...
                    echo '  <td>';
                    echo '      <a href="javascript:void(0);" class="btn btn-sm btn-primary btn-round" data-toggle="modal" data-target="#ModalKonfirmasiDiagnosa" data-id="'.$kode.'">';
                    echo '          '.$kode.'';
                    echo '      </a>';
                    echo '  </td>';
