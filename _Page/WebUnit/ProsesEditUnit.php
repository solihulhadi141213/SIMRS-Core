        ...
        if(empty($_POST['nama_unit_instalasi'])){
            ...
            if(empty($_POST['deskripsi_unit_instalasi'])){
                ...
                if(!empty($err)){
                    ...
                    if($code==200){
                        $_SESSION['NotifikasiSwal']="Edit Unit Berhasil";
                        echo '<span class="text-success" id="NotifikasiEditUnitBerhasil">Success</span>';
                    }else{
