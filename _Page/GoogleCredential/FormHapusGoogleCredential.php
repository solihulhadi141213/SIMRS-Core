...
?>
    <input type="hidden" name="id_setting_google" value="<?php echo $data['id_setting_google']; ?>">
    <div class="row mb-2">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="alert alert-danger text-center">
                <b>PENTING!</b><br>
                Menghapus pengaturan kredensial google ini mungkin akan menyebabkan fitur login dengan google tidak berfungsi.<br>
                <small>
