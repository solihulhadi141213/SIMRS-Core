<?php
    ...
    $UrlInfo=urlService('Info Artikel');
    $UrlList=urlService('List Artikel');
    //keyword
...
<script>
    ...
    $('#NextPage').click(function() {
        ...
        $.ajax({
            url     : "_Page/WebArtikel/TabelWebArtikel",
            method  : "POST",
            ...
            <tbody>
                            ...
                            if($code!==200){
                                ...
                                if(empty($JumlahBaris)){
                                    ...
                                    foreach($list_data as $value){
                                        $id_web_artikel=$value['id_web_artikel'];
                                        $artikel_judul=$value['artikel_judul'];
                                        $artikel_tanggal=$value['artikel_tanggal'];
                                        $artikel_penulis=$value['artikel_penulis'];
                                        $artikel_kategori=$value['artikel_kategori'];
                                        $artikel_ringkasan=$value['artikel_ringkasan'];
                                        $artikel_isi=$value['artikel_isi'];
                                        $artikel_status=$value['artikel_status'];
                                        $strtotime=strtotime($artikel_tanggal);
                                        $FormatTanggal=date('d/m/Y H:i',$strtotime);
                                        if($artikel_status=="Publish"){
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left"><?php echo "<dt>$artikel_judul</dt>Kategori: $artikel_kategori"; ?></td>
                        <td class="text-left"><?php echo "<dt>$artikel_penulis</dt>$FormatTanggal"; ?></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group dropdown-split-inverse">
                                ...
                                <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(107px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalDetailArtikel" data-id="<?php echo "$id_web_artikel"; ?>">
                                        <i class="ti ti-info-alt"></i> Detail
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="index.php?Page=WebArtikel&Sub=EditArtikel&id=<?php echo "$id_web_artikel"; ?>">
                                        <i class="ti-pencil"></i> Edit
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item waves-effect waves-light" href="javascript:void(0);" data-toggle="modal" data-target="#ModalHapustArtikel" data-id="<?php echo "$id_web_artikel"; ?>">
