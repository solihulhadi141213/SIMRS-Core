...
?>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col col-md-12 text-center mb-3">
                    <span class="text-dark" id="NotifikasiHapusSettingBridging">
                        Anda Yakin Ingin Menghapus Profile Setting Bridging Ini?
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer bg-danger">
        <div class="row">
            <div class="col col-md-12 text-center">
                <button type="button" id="KonfirmasiHapusSettingBridging" class="btn btn-sm btn-primary">
