        ...
        if(empty($_POST['id_bridging'])){
            ...
            if($status=="Aktiv"){
                ...
                if($UpdateBridging){
                    ...
                    if($Input){
                        $MenyimpanLog=getSaveLog($Conn,$now,$SessionNama,"Simpan Setting Bridging","Setting",$SessionIdAkses,$LogJsonFile);
                        if($MenyimpanLog=="Berhasil"){
                            $_SESSION['NotifikasiSwal']="Simpan Setting Berhasil";
                            echo '<span class="text-success" id="NotifikasiSimpanSettingBridgingBerhasil">Success</span>';
                        }else{
                            echo '<span class="text-danger">Terjadi Kesalahan Pada Saat Menyimpan Log!</span>';
                        }
                    }else{
                        echo '<span class="text-danger">Tambah Profile Setting Bridging Gagal!!</span>';
                    }
                }else{
