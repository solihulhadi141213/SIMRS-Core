            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-xl-12 col-md-12">
                        ...
                        ?>
                        <form action="javascript:void(0);" id="ProsesVerifikasiRadiografer">
                            ...
                            <div class="card table-card">
                                <div class="card-header border-info">
                                    <div class="row">
                                        <div class="col-md-10 mb-3">
                                            <h4 class="text-dark">
                                                <i class="icofont-prescription"></i> Form Verifikasi Petugas Radiografer
                                            </h4>
                                        </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label for="nama"><dt>Nama Radiografer</dt></label>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12" id="NotifikasiVerifikasiRadiografer">
