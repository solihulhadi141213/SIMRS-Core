            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-xl-12 col-md-12">
                        ...
                        ?>
                        <form action="javascript:void(0);" id="ProsesPengisianKlinisPasien">
                            ...
                            <div class="card table-card">
                                <div class="card-header border-info">
                                    <div class="row">
                                        <div class="col-md-10 mb-3">
                                            <h4 class="text-dark">
                                                <i class="icofont-prescription"></i> Form Pengisian Klinis Pasien
                                            </h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-md-8">
                                            <textarea name="klinis" id="klinis" class="form-control" cols="30" rows="3"><?php echo $KlinisPasien; ?></textarea>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12" id="NotifikasiPengisianKlinisPasien">
