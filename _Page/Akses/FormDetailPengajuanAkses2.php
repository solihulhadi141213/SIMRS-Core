...
?>
    <div class="modal-body pre-scrollable">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <dt>Foto <a href="javascript:void(0);" id="TampilkanFotoPengajuan2" class="text-success">(Tampilkan)</a></dt>
                <small class="text-muted"><?php echo "$foto"; ?></small><br>
                <div id="TempatMenampilkanFoto2"></div>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-12">
    ...
    <div class="modal-footer bg-info">
        <a href="index.php?Page=Akses&Sub=DetailPengajuanAkses&id=<?php echo "$id_akses_pengajuan"; ?>" class="btn btn-sm btn-success">
