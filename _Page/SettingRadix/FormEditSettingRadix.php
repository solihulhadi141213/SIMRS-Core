<?php
    ...
    if (empty($_POST['id_setting_radix'])) {
        echo '
            <div class="alert alert-danger text-center">
                <small>ID setting Radix tidak boleh kosong.</small>
            </div>
        ';
        exit;
    }
    ...
    $stmt = mysqli_prepare(
        $Conn,
        "SELECT * FROM setting_radix WHERE id_setting_radix = ?"
    );
    ...
    if (!$result || mysqli_num_rows($result) == 0) {
        ...
        echo '
            <div class="alert alert-warning text-center">
                <small>Data setting Radix tidak ditemukan.</small>
            </div>
        ';
        exit;
    }
...
?>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <label for="nama_setting_radix_edit"><small>Profil Pengaturan</small></label>
            <input
                type="text"
                name="nama_setting_radix"
                id="nama_setting_radix_edit"
                class="form-control"
    ...
    <div class="row mb-3">
        <div class="col-12">
            <label for="url_radix_edit"><small><i>URL (ENDPOINT)</i></small></label>
            <input
                type="url"
                name="url_radix"
                id="url_radix_edit"
