        ...
        <div class="row mb-2">
            <div class="col-12">
                <div class="alert alert-warning text-center">
                    <small>
                        <b>PENTING</b><br>
                        Secara umum referensi tindakan tidak akan dihapus secara permanen. <br> 
                        Selama status terhapus maka referensi tidak dapat digunakan untuk kepentingan record transaksi.
                    </small>
                </div>
            </div>
        </div>
