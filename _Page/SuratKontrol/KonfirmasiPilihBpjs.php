<?php
    ...
    if(empty($_POST['BPJS'])){
        ...
        echo '          Data BPJS Tidak Dapat didefinisikan.';
        echo '      </div>';
        echo '  </div>';
        echo '</div>';
    }else{
    ...
    <div class="modal-body border-0 pb-0 mb-4">
        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-primary">
                <span id="">
                    Apakah anda yakin akan menambahkan BPJS berdasarkan data Kunjungan ini?
                </span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-3 text-center">
                <a href="javascript:void(0);" class="btn btn-sm btn-inverse mt-2 ml-2" id="KonfirmasiYaBPJS">
