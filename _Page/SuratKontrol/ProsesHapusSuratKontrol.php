<?php
    ...
    if(empty($_POST['noSuratKontrol'])){
        echo '<div class="text-danger">Surat Kontrol Tidak Boleh Kosong!!</div>';
    }else{
        ...
        $URLUtama=$url_vclaim;
        $URLKatalog="RencanaKontrol/Delete";
        ...
        if($code=="200"){
            echo '<span class="text-info" id="NotifikasiHapusSuratKontrolBerhasil">Berhasil</span><br>';
        }else{
            echo '<span class="text-danger">Maaf, Hapus SPRI gagal!!</span><br>';
