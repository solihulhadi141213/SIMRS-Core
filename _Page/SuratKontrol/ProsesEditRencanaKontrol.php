    ...
    if(empty($_POST['JenisKontrol'])){
        ...
        if($JenisKontrol=="1"){
                    ...
                    if(empty($_POST['kodeDokter'])){
                        ...
                        if(empty($_POST['tglRencanaKontrol'])){
                            ...
                            if(empty($_POST['user'])){
                                ...
                                $URLUtama=$url_vclaim;
                                $URLKatalog="RencanaKontrol/UpdateSPRI";
                                ...
                                if($code=="200"){
                                    ...
                                    if(!empty($noSPRI)){
                                        echo '<span class="text-info" id="NotifikasiEditRencanaKontrolBerhasil">Berhasil</span><br>';
                                    ...
                                    echo '<span class="text-danger">Keterangan :'.$content.'<br>';
                                    echo '<span class="text-danger">Keterangan :'.$json.'<br>';
                                }
                            }
                        }
                    }
            ...
            if(empty($_POST['noSuratKontrol'])){
                echo '<div class="text-danger">Nomor Surat Kontrol Tidak Boleh Kosong!!</div>';
            }else{
                        ...
                        if(empty($_POST['kodeDokter'])){
                            ...
                            if(empty($_POST['tglRencanaKontrol'])){
                                ...
                                if(empty($_POST['user'])){
                                    ...
                                    $TanggalSekarang=date('Y-m-d');
                                    $URLUtama=$url_vclaim;
                                    $URLKatalog="RencanaKontrol/Update";
                                    $url="$URLUtama$URLKatalog";
                                    //Mulai CURL
                                    $ch = curl_init();
                                    curl_setopt($ch,CURLOPT_URL, "$url");
