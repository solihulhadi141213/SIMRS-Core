        ...
        <div class="row mt-2 mb-2"> 
            <div class="col-md-12 text-center text-primary">
                <span id="NotifikasiHapusSuratKontrol">
                    Apakah anda yakin akan menghapus surat kontrol <?php echo "<dt>$noSuratKontrol</dt>"; ?> ini?
                </span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-3 mt-3 text-center">
                <a href="javascript:void(0);" class="btn btn-md btn-inverse btn-round mt-2 ml-2" id="KonfirmasiHapusSuratKontrolYa">
