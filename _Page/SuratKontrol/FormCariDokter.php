<?php
    ...
    if(empty($_POST['JenisKontrol'])){
        ...
        if(empty($_POST['poliKontrol'])){
            ...
            echo '  <div class="row">';
            echo '      <div class="col-md-12 text-danger">';
            echo '          Kode Poli Tidak Boleh Kosong!!';
            echo '      </div>';
            echo '  </div>';
            echo '</div>';
            echo '<div class="modal-footer">';
            ...
            if(empty($_POST['tglRencanaKontrol'])){
                ...
                $URLUtama=$url_vclaim;
                $URLKatalog="RencanaKontrol/JadwalPraktekDokter/JnsKontrol/$JenisKontrol/KdPoli/$poliKontrol/TglRencanaKontrol/$tglRencanaKontrol";
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><dt>Jadwal Praktek</dt></th>
                        ...
                        <tbody>
                            <?php
                                ...
                                for($a=0; $a<$Jumlah; $a++){
                                    ...
                                    $jadwalPraktek=$list[$a]['jadwalPraktek'];
                                    $kapasitas=$list[$a]['kapasitas'];
                                    echo '<tr>';
                                    echo '  <td class="text-center">'.$no.'</td>';
                                    echo '  <td><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#ModalKonfirmasiPilihDokter" data-id="'.$kodeDokter.'">'.$kodeDokter.'</button></td>';
                                    echo '  <td>'.$namaDokter.'</td>';
                                    echo '  <td>'.$jadwalPraktek.'</td>';
