        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">
                        <a href="" class="h5"><i class="bi bi-layers"></i> Entitas Akses</a>
                    </h5>
                    <p class="m-b-0">Kelola Entitas Akses Yang Menunjukan Group Akses Tertentu </p>
                </div>
            </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12 text-end icon-btn">
                                        ...
                                        <button type="button" class="btn btn-md btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahEntitas" title="Tambah Entitas">
                                    ...
                                    <table class="table table-hover table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <td align="left"><small><b>Entitas Akses</b></small></td>
                                                <td align="left"><small><b>Deskripsi</b></small></td>
                                                <td align="center"><small><b>Fitur</b></small></td>
                                                <td align="center"><small><b>Pengguna</b></small></td>
                                                <td align="center"><small><b>Opsi</b></small></td>
                                            </tr>
                                        </thead>
                                        <tbody id="tabel_entitas">
