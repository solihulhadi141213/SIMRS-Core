			...
			try {
				...
				if(empty($headers['x-username'])){
					...
					if(empty($ValidasiUsername)){
						$metadata = Array (
                            "message" => "x-username : $Username Tidak Terdaftar",
                            "code" => 201,
                        );
                        $Array = Array (
                            "metadata" => $metadata
                            ...
                            if(empty($Tangkap['keterangan'])){
                                ...
                                if($Update){
                                    ...
                                    if($codeWsBpjs==200){
                                        ...
                                        $metadata = Array (
                                            "message" => "Update Pembatalan Ke WS BPJS Gagal",
                                            "code" => 201,
                                        );
                                        $Array = Array (
                                            "metadata" => $metadata
